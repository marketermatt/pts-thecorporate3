<?php
/**
 * Template Name: Left + Main + Inset Column
 * @package WordPress
...
<div id="commentswrapper">
	<?php comments_template(); ?>
        ...
        <div id="inset" style="margin-right:0;">
            <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Inset Column')) :
                _e('Please setup a widget in this sidebar', 'thecorporate');
            endif; ?>
        </div>
